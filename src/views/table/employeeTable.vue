<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select clearable style="width: 90px" class="filter-item" v-model="listQuery.importance" :placeholder="$t('table.telephone')">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column min-width="150px" :label="$t('table.age')">
        <template slot-scope="scope">
      ...
      <el-table-column width="110px" v-if='showReviewer' align="center" :label="$t('table.position')">
        <template slot-scope="scope">
          <span style='color:red;'>{{scope.row.reviewer}}</span>
        </template>
      </el-table-column>
      <el-table-column width="80px" :label="$t('table.workingYears')">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisible = false">{{$t('table.detail')}}</el-button>
      </div>
    </el-dialog>
